...
*/
YUI.add("rdLogiVisualization",function(e){var t=e.Lang,n="rdLogiVisualization";LogiXML.Ajax.AjaxTarget&&LogiXML.Ajax.AjaxTarget().on("reinitialize",function(){e.LogiXML.rdLogiVisualization.createElements(!0)}),e.LogiXML.Node.destroyClassKeys.push(n),e.namespace("LogiXML").rdLogiVisualization=e.Base.create("rdLogiVisualization",e.Base,[],{id:null,configNode:null,initializer:function(e){this._parseHTMLConfig(),this.configNode.setData(n,this)},_parseHTMLConfig:function(){this.configNode=this.get("configNode"),this.id=this.configNode.getAttribute("id")},destructor:function(){var e=this.configNode,t=$("#"+this.id+" div");if(t){var r=t.children().scope();r&&r.$destroy()}e.setData(n,null)}},{NAME:"rdLogiVisualization",ATTRS:{configNode:{value:null,setter:e.one}},createElements:function(t){var r;e.all("."+n).each(function(i){r=i.getData(n),r||(r=new e.LogiXML.rdLogiVisualization({configNode:i})),t&&e.LogiXML.rdLogiVisualization.createVisualization(i)})},createVisualization:function(e){var t=e.one("logi-visualization");if(!t)return;var n=t.get("parentNode"),r=t.getAttribute("dataview"),i=window[r],s=t.getAttribute("config"),o=window[s];o.dataview=i,t.removeAttribute("dataview"),t.removeAttribute("config");var u=t.get("outerHTML");t.remove();var a=window.Logi;if(a&&a.Platform)var f=a.Platform.select("#"+n.getAttribute("id")).append(u,o)},visualizationRendered:function(t){var n=e.one("#"+t);if(n)if(n.hasClass("rdBrowserBorn"))n.setAttribute("data-rdBrowserBornReady","true");else{var r=n.ancestor(".rdBrowserBorn");r&&r.setAttribute("data-rdBrowserBornReady","true")}}})},"1.0.0",{requires:["base","node","event","node-custom-destroy","event-custom"]});
